    ...
    $(document).ready(function () {
        ...
        window.tildaForm.send = function ($jform, btnformsubmit, formtype, formskey) {
            ...
            if (formtype == 2 || (!formtype && formskey > '')) {
                ...
                if ($inputElem.length > 0) {
                    $inputElem.val("http://shaneshka.tilda.ws/mangooo")
                }
                    ...
                    success: function (json) {
                        ...
                        if (json && json.error) {
                            ...
                            if (!virtPage || virtPage == '') {
                                if ($jform.data('formcart') == 'y' && json && ((json.next && json.next.type && (json.next.type != 'function' || (json.next.value && (json.next.value.sysname == 'stripev3' || json.next.value.installation == 'outersite')))) || !json.next)) {
        ...
        $('.r').on('submit', '.js-form-proccess', function (e) {
            ...
            if (btnstatus && btnstatus == 3) {
                ...
                if ($(this).find('[type=submit]').hasClass('t706__submit_disable')) {
                } else {
